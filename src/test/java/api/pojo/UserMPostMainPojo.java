...
public class UserMPostMainPojo {
	...
	private UserMPostLoginPojo userLogin;
	
	private String userMiddleName;
	private String userPhoneNumber;
	
	private List<UserMPostRoleMapPojo> userRoleMaps;
	...
	public UserMPostLoginPojo getUserLogin() {
		return userLogin;
	}
	public void setUserLogin(UserMPostLoginPojo userLogin) {
	...
	public List<UserMPostRoleMapPojo> getUserRoleMaps() {
		return userRoleMaps;
	}
	public void setUserRoleMaps(List<UserMPostRoleMapPojo> userRoleMaps) {
